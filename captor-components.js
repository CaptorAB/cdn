...
!(function (e, t) {
  ...
  const Ly = (e, t) => am.merge(e, t),
    ...
    Uy = (e) => {
      ...
      const i = [
        ...
        [l, s] = Re.useState(Nm.addYears(new Date(), -1)),
        [u] = Re.useState(new Date()),
      ...
      if (
        (Re.useEffect(() => {
          const e = n.map((e, t) =>
            ...
            })(e.range(l, u).normalize(1).add(-1), e.name, i[t])
          );
          f(e), p(d + 1);
        }, [l, u, n]),
        !c)
        ...
        return null;
      const v = c.map((e) => e.y.reduce((e, t) => Math.max(Math.abs(t), e), 0)),
        m = Math.max(v.reduce((e, t) => Math.max(Math.abs(t), e), 0));
      let y = zy(
        {
          autosize: !0,
          dragmode: !1,
  ...
  const Pk = (e, t) =>
    `https://api.qipple.com/public/api/calendars?isins=${e}&year=${t}`;
  function Dk({
    isin: e,
    year: t,
    month: n,
